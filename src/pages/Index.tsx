...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-sachiv-primary/10 to-white">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6">
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-sachiv-dark">
            {language === 'english' 
              ? 'Your Gram Panchayat Assistant' 
              : 'आपका ग्राम पंचायत सहायक'}
          </p>
        </div>
        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <Link to="/voice-agent" className="w-full block">
            <Button 
              className="w-full btn-secondary h-20 text-xl"
            >
        ...
        <div className="mt-16 max-w-md text-center">
          <p className="text-sachiv-gray">
            {language === 'english' 
              ? 'AI Sachiv helps Gram Panchayat Sarpanchs with their daily responsibilities. Choose a mode to get started.' 
              : 'एआई सचिव ग्राम पंचायत सरपंचों को उनकी दैनिक जिम्मेदारियों में मदद करता है। शुरू करने के लिए एक मोड चुनें।'}
          </p>
        </div>
      </main>
    </div>
